...
HD_PWD='D:/FPGA/gates2/gates2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gates2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gates2.tcl -notrace
